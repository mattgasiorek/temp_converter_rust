...
'main_loop: loop { //main loop
    println!("Type 'exit' or 'quit' to exit the program, or press the enter key to convert a temperature.");
...
if decision == "quit" || decision == "exit" {
    ...
    let unit: String = loop {
        println!("Please enter the unit of this temperature (C for Celsius, F for Fahrenheit):");
